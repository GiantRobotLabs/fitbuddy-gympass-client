...
GymPassViewController *gymPassInstance;

@interface GymPassViewController ()
{
    BOOL loaded;
    GymPassViewController *instance;
}
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [[AppDelegate sharedAppDelegate] setGymPassViewController:self];
...
{
    [[AppDelegate sharedAppDelegate] setGymPassViewController:nil];
}
